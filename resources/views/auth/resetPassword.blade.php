...
<body>
    <div class="login-wrap">
        <div class="login-body">
            ...
            <form class="login-content" action="{{route('admin.postResetPassword')}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <span style="color:#bdc3c7; font-size:13px; margin-top: 5px">{{$errors->first('password_confirmation')}}</span>
                </div>
                <div class="form-group">
                    <label for="">Verify from Mail</label>
                    <input type="text" class="form-control" name="token" value="{{old('token')}}" placeholder="Nhập mã xác thực">
                    <span style="color:#bdc3c7; font-size:13px; margin-top: 5px">{{$errors->first('token')}}</span>
                    <span style="color:#bdc3c7; font-size:13px; margin-top: 5px">{{session('verify_token')}}</span>
                </div>
